...
/*
  Pas de fixture Visibilité ici depuis Admin-2B (voir docs/VISIBILITE.md) :
  les campagnes ne vivent plus dans une Content Collection Astro (donc plus
  de fichier Markdown à créer avant le build) mais dans visibilites.json,
  géré par l'API PHP côté serveur. Les tests E2E du module Visibilité
  (e2e/visibilite.spec.ts) simulent désormais cette API via
  `page.route()` (voir e2e/visibilite-mock.ts), pas via ce fichier.
*/
